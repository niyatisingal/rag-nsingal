...
class NvidiaRAGIngestor:
    ...
    async def __perform_shallow_extraction_workflow(
        ...
        if not ENABLE_NV_INGEST_BATCH_MODE:
            ...
            # Batch mode
            num_batches = (
                len(filepaths) + NV_INGEST_FILES_PER_BATCH - 1
            ...
            if not ENABLE_NV_INGEST_PARALLEL_BATCH_MODE:
                ...
                tasks = []
                semaphore = asyncio.Semaphore(NV_INGEST_CONCURRENT_BATCHES)
    ...
    async def __nvingest_upload_doc(
        ...
        if not ENABLE_NV_INGEST_BATCH_MODE:
            ...
            if not ENABLE_NV_INGEST_PARALLEL_BATCH_MODE:
                ...
                # Process batches in parallel with worker pool of NV_INGEST_CONCURRENT_BATCHES
                logger.info(
